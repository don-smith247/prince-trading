...
import { Menus } from './utils'; // Assuming Menus is an array of menu items
          ...
          <div className="space-y-6 transform transition-all duration-500 hover:translate-y-[-5px]">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 text-gray-300">
                ...
                <p>MTN PLAZA, 1st floor opposite Juniwad filing Station, Tanke, Ilorin Kwara state</p>
              </div>
              <div className="flex items-center gap-3 text-gray-300">
                <Phone className="w-5 h-5 text-blue-400" />
                <p>+234 901 697 4874</p>
              </div>
              <div className="flex items-center gap-3 text-gray-300">
                <Mail className="w-5 h-5 text-blue-400" />
                <p>ibacademy111@gmail.com</p>
              </div>
            </div>
        ...
        <header className="h-16 text-[15px] fixed inset-0 flex items-center border-b border-gray-300 bg-white z-50">
          <nav className="px-3.5 flex justify-between w-full max-w-7xl mx-auto">
            <div className="flex items-center gap-x-3">
              <h3 className="text-lg font-semibold">Prince Trading Academy</h3>
            </div>
